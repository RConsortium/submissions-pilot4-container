...
``` sh
m5\datasets\rconsortiumpilot4\analysis\adam\programs\r1pkg.txt
```
...
``` r
pkglite::unpack(
  input = "C:/pilot4container/m5/datasets/rconsortiumpilot4/analysis/adam/programs/r1pkg.txt", 
...
# copy data files
file.copy(
  from =  "C:/pilot4container/m5/datasets/rconsortiumpilot4/analysis/adam/datasets",
...
file.copy(
  from = "C:/pilot4container/m5/datasets/rconsortiumpilot4/analysis/adam/programs/Dockerfile.txt",
  to = "C:/pilot4container_files"
)
```
